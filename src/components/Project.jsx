    ...
    <div>
      ...
      >
        ...
        <div className="w-3/4 flex flex-col gap-2">
          ...
          <p className="text-sm font-light text-gray-300">{project.text}</p>
      ...
      {projectPopUpWindow && (
        <div className="fixed top-0 left-0 bottom-0 overflow-y-scroll z-10 blur-2 bg-black/40 w-full p-6">
          <div className="relative border-2 m-auto border-white md:w-2/5 w-full md:px-6 md:py-6 px-3 py-3 rounded-md bg-gradient-to-tr from-black to-slate-900 flex flex-col gap-2">
            ...
            <p className="text-sm font-light text-slate-300">{project.text}</p>
            {showDescription && (<p className="text-sm font-light text-slate-300">{project.description}</p>)}
            ...
            <button
              className="text-2xl text-white absolute right-3 top-3 shadow-md p-2 rounded-full"
              onClick={() => {
